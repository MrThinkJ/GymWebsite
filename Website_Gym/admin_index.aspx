            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between mb-1">
                <div class="">
                  ...
                  <p class="mb-0" id="targetUsers">200<span> Users</span> </p>
                </div>
              </div>
              ...
              <div class="text-center">
                <!-- Biểu đồ tôi chỉnh rồi đổ data vào đây là được -->
                <p class="mb-0 font-12" id="numberUsers"><asp:Literal runat="server" ID="totalUsers1"></asp:Literal><span> Users</span></p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="">
                  ...
                  <p class="mb-0" id="onlineUsers"><asp:Literal runat="server" ID="userOnline"></asp:Literal></p>
                </div>
              </div>
              <div class="chart-container2">
                <div id="chart2"></div>
              ...
              <div class="text-center">
                <p class="mb-0 mt-1 font-12"><span class=" me-1" id="percentageChange"><asp:Literal runat="server" ID="totalUsers3"></asp:Literal></span>Users in total</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="d-flex flex-column gap-3">
                ...
                <div class="position-relative">
                  <div class="piechart-legend">
                    <h2 class="mb-1"><asp:Literal runat="server" ID="totalUsers2"></asp:Literal></h2>
    ...
    <asp:Repeater ID="classRepeater" runat="server">
        <ItemTemplate>
            <div class="d-flex align-items-center justify-content-between class-entry">
                ...
                <div class="">
                    <p class="class-value mb-0"><%# Eval("CustomerCount") %></p>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
