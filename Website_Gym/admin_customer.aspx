                            ...
                            <div class="col-auto">
                                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                                    ...
                                    <button class="btn btn-primary px-4">
                                        <i class="bi bi-plus-lg me-2"></i><a href="#instructorInformation"
                        ...
                        <div class="card-body">
                            <div class="customer-table">
                                <div class="table-responsive white-space-nowrap">
                                    <asp:GridView ID="gvStudents" runat="server" AutoGenerateColumns="False" CssClass="table align-middle">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <div class="d-md-flex d-grid align-items-center gap-1">
                                                        <asp:Button runat="server" Text="Delete" CssClass="btn btn-grd-primary px-1" CommandName="Delete" CommandArgument='<%# Eval("customer_id") %>' OnCommand="ActionButton_Command" />
                                                        <asp:Button runat="server" Text="Edit" CssClass="btn btn-grd-info px-1" CommandName="Edit" CommandArgument='<%# Eval("customer_id") %>' OnCommand="ActionButton_Command" />
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                        ...
                        <div id="instructorInformation" runat="server">
                            <div class="card-body p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:DropDownList ID="ddlClasses" runat="server" CssClass="form-select" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <asp:Label AssociatedControlID="ddlInstructors" CssClass="col-sm-3 col-form-label" runat="server">Select Instructor</asp:Label>
                                    <div class="col-sm-9">
                                        <asp:DropDownList ID="ddlInstructors" runat="server" CssClass="form-select" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row">
